...
// Admin — pages (your existing files)
...
// Admin — new shells (you need to create these three)
    ...
    <BrowserRouter>
      ...
      <div className="font-body">
        <Routes>
          ...
          <Route path="/forgot-password" element={<Placeholder title="Forgot password" body="Password recovery is coming soon." />} />
          <Route path="/terms" element={<Placeholder title="Terms and conditions" body="Our terms and conditions are being prepared." />} />
          ...
          {/* Staff self-signup removed — accounts are created by admin */}
            ...
            element={
              <div className="min-h-screen flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="mt-2 text-slate-500">You don't have admin access.</p>
                </div>
              </div>
            }
          />
